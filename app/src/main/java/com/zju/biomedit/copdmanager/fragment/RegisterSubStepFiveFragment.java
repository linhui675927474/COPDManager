 ...
 */
public class RegisterSubStepFiveFragment extends Fragment {
    ...
    public RegisterSubStepFiveFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_regist_sub_step_five, container, false);
    ...
    private void setListener() {
        ...
        btnPreviousStep.setOnClickListener((View v) ->{
            if(hostActivity instanceof FragmentRegister){
                ((FragmentRegister)hostActivity).onPreviousStepButtonClick(Utils.REGISTER_STEP_WEIGHT);
            }
        });

        btnNextStep.setOnClickListener((View v) -> {
            if(hostActivity instanceof FragmentRegister){
                int weight = Integer.parseInt(edtInput.getText().toString());
                String info = String.valueOf(weight);
                ((FragmentRegister)hostActivity).onNextStepButtonClick(info, Utils.REGISTER_STEP_WEIGHT);
            }
        });
    }
