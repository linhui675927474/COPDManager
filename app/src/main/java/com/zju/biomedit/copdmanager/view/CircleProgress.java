...
import com.zju.biomedit.copdmanager.support.Constant;
import com.zju.biomedit.copdmanager.support.MiscUtil;


/**
 * 自定义圆形进度条
 * Created by wzy on 2017/6/16.
 */
...
public class CircleProgress extends View {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        mTextOffsetPercentInRadius = typedArray.getFloat(R.styleable.CircleProgressBar_textOffsetPercentInRadius, 0.35f);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mValueOffset = mCenterPoint.y + getBaselineOffsetFromY(mValuePaint) - mRadius * 0.1f;
    ...
    private void updateArcPaint() {
        // 设置渐变
        int[] mGradientColors = {Color.RED, Color.YELLOW, Color.GREEN};
