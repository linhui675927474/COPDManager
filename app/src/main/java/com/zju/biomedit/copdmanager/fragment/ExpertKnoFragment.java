 ...
 */
public class ExpertKnoFragment extends Fragment {
    ...
    private void getKnoData() {
        ...
        String url = "http://120.27.141.50:8080/health-knowledge/GetCOPDVideoInfo.jsp?videoType=1";
        ...
        public void onEvent(int type, String url, int screen, Object... objects) {
            switch (type) {
                case JCUserAction.ON_CLICK_START_ICON:
                    UserAgent.OnEvent(getActivity().getApplicationContext(), Utils.E_VIDEO_EXPERT);
                    break;
            }
        }
    }
